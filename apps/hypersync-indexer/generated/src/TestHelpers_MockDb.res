...
and entities = {
    ...
    @as("AccountBalance") accountBalance: entityStoreOperations<Entities.AccountBalance.t>,
    @as("AccountPower") accountPower: entityStoreOperations<Entities.AccountPower.t>,
    @as("BalanceHistory") balanceHistory: entityStoreOperations<Entities.BalanceHistory.t>,
    @as("DaoMetricsDayBucket") daoMetricsDayBucket: entityStoreOperations<Entities.DaoMetricsDayBucket.t>,
    @as("Delegation") delegation: entityStoreOperations<Entities.Delegation.t>,
    @as("FeedEvent") feedEvent: entityStoreOperations<Entities.FeedEvent.t>,
    @as("ProposalOnchain") proposalOnchain: entityStoreOperations<Entities.ProposalOnchain.t>,
    @as("Token") token: entityStoreOperations<Entities.Token.t>,
    @as("TokenPrice") tokenPrice: entityStoreOperations<Entities.TokenPrice.t>,
    ...
    @as("VoteOnchain") voteOnchain: entityStoreOperations<Entities.VoteOnchain.t>,
    @as("VotingPowerHistory") votingPowerHistory: entityStoreOperations<Entities.VotingPowerHistory.t>,
  }
  ...
  let entities = {
      account: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Account)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Account.t,
            >
      ...
      accountBalance: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.AccountBalance)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.AccountBalance.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      accountPower: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.AccountPower)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.AccountPower.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      balanceHistory: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.BalanceHistory)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.BalanceHistory.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      daoMetricsDayBucket: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.DaoMetricsDayBucket)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.DaoMetricsDayBucket.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      feedEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.FeedEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.FeedEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      proposalOnchain: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.ProposalOnchain)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.ProposalOnchain.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      tokenPrice: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TokenPrice)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
      ...
      voteOnchain: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.VoteOnchain)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.VoteOnchain.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      votingPowerHistory: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.VotingPowerHistory)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.VotingPowerHistory.t,
            >
          ),
          ~getKey=({id}) => id,
        )
