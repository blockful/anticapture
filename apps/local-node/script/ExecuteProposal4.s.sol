...
// apps/local-node/script/ExecuteProposal4.s.sol
...
/**
 * @title ExecuteProposal4
 * @dev Script to execute Proposal 4 (Transfer 3 ENS to Alice) after it's queued
 ...
 */
contract ExecuteProposal4 is BaseExecuteProposal {
