// apps/local-node/script/CreateProposal2.s.sol
...
/**
 * @title CreateProposal2
 * @dev Script to create the second governance proposal
 ...
 */
contract CreateProposal2 is BaseCreateProposal {
