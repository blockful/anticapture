...
// apps/local-node/script/ExecuteProposal3.s.sol
...
/**
 * @title ExecuteProposal3
 * @dev Script to execute Proposal 3 (Transfer 5 ENS to David) after it's queued
 * Inherits from BaseExecuteProposal for reusable functionality
 */
contract ExecuteProposal3 is BaseExecuteProposal {
