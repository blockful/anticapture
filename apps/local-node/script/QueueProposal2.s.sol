...
// apps/local-node/script/QueueProposal2.s.sol
...
/**
 * @title QueueProposal2
 * @dev Script to queue Proposal 2 (Transfer 5 ENS to Charlie) after it succeeds
 * Inherits from BaseQueueProposal for reusable functionality
 */
contract QueueProposal2 is BaseQueueProposal {
