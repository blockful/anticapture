export const GovernorAbi = [
  ...
  { inputs: [], name: "InvalidEmptyProposal", type: "error" },
  { inputs: [], name: "InvalidProposalExists", type: "error" },
  { inputs: [], name: "InvalidProposalId", type: "error" },
  { inputs: [], name: "InvalidProposalLength", type: "error" },
  {
  ...
  { inputs: [], name: "InvalidVotesBelowThreshold", type: "error" },
  { inputs: [], name: "NotAlligator", type: "error" },
  { inputs: [], name: "NotManagerOrTimelock", type: "error" },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "contract IVotableSupplyOracle",
        name: "_votableSupplyOracle",
        type: "address",
      },
      { internalType: "address", name: "_manager", type: "address" },
      { internalType: "address", name: "_alligator", type: "address" },
      {
      ...
      {
        components: [
          { internalType: "uint16", name: "quorum", type: "uint16" },
