export const aAave = [
  {
    inputs: [
      ...
      { internalType: "address", name: "rewardsController", type: "address" },
      { internalType: "address", name: "treasury", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "CallerMustBePool", type: "error" },
  ...
  { inputs: [], name: "PoolAddressesDoNotMatch", type: "error" },
  {
    inputs: [
  ...
  { inputs: [], name: "UnderlyingCannotBeRescued", type: "error" },
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum IBaseDelegation.GovernancePowerType",
        name: "delegationType",
        type: "uint8",
      },
    ],
