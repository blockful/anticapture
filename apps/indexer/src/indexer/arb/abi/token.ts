export const ARBTokenAbi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "_arbOneGateway", type: "address" },
      { internalType: "address", name: "_novaRouter", type: "address" },
      { internalType: "address", name: "_novaGateway", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "maxGasForRouter", type: "uint256" },
          { internalType: "uint256", name: "gasPriceBid", type: "uint256" },
          { internalType: "uint256", name: "valueForGateway", type: "uint256" },
          { internalType: "uint256", name: "valueForRouter", type: "uint256" },
          {
            internalType: "address",
        ...
        internalType: "struct INovaArbOneReverseToken.RegistrationParams",
        name: "novaParams",
        type: "tuple",
      },
    ],
