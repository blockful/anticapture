export const DaoOverviewSkeleton = () => {
  return (
    <div className="dark flex min-h-screen w-full flex-col gap-8 border-b-2 border-b-white/10 px-4 lg:gap-6 lg:border-none lg:p-5">
      <div className="flex-1 space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:grid-cols-4">
