...
export const RequestFeatureSection = () => {
  ...
  return (
    <TheSectionLayout
      ...
      description={`We're committed to building the best possible experience through the ${daoConfig.name} Governance Dashboard. The best ideas come from the community — share your suggestions for new features, metrics, and improvements you'd like to see.`}
    >
      <div className="bg-surface-default w-full max-w-2xl space-y-6 p-5">
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription className="text-secondary">
                    The more detail you share, the better we can bring your idea
                    to life.
                  </FormDescription>
                </FormItem>
              )}
