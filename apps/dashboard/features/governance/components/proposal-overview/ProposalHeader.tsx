...
export const ProposalHeader = ({
  ...
  return (
    <div className="text-primary bg-surface-background border-border-default sticky top-[64px] z-20 flex h-[65px] w-full shrink-0 items-center justify-between gap-6 border-b py-2 lg:top-0">
