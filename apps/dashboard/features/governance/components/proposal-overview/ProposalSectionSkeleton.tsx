  ...
  return (
    <div>
      ...
      <div className="border-border-default mx-auto flex h-[65px] w-full shrink-0 items-center justify-between gap-6 border-b px-5 py-2">
        <div className="border-light-dark m-auto flex w-full max-w-screen-2xl items-center justify-between border">
      ...
      <div className="border-light-dark mx-auto flex w-full max-w-screen-2xl flex-col gap-6 border p-5 lg:flex-row">
