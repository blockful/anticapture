  ...
  return (
    ...
    >
      <g id="users">
        ...
        <path
          id="Vector_3"
          d="M14.6666 13.9998V12.6664C14.6662 12.0756 14.4695 11.5016 14.1075 11.0346C13.7455 10.5677 13.2387 10.2341 12.6666 10.0864"
          stroke="currentColor"
          strokeWidth="1.25"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        <path
          id="Vector_4"
          d="M10.6666 2.08643C11.2402 2.23329 11.7487 2.56689 12.1117 3.03463C12.4748 3.50237 12.6719 4.07765 12.6719 4.66976C12.6719 5.26187 12.4748 5.83715 12.1117 6.30489C11.7487 6.77262 11.2402 7.10623 10.6666 7.25309"
          stroke="currentColor"
          strokeWidth="1.25"
          strokeLinecap="round"
          strokeLinejoin="round"
