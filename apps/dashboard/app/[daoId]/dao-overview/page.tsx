...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  return {
    title: `Anticapture - ${daoId} DAO Overview`,
    description: `Explore ${daoId} DAO overview and governance information.`,
    openGraph: {
      title: `Anticapture - ${daoId} DAO Overview`,
      description: `Explore ${daoId} DAO overview and governance information.`,
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${daoId} DAO Overview Open Graph Image`,
        },
      ],
    },
    twitter: {
...
export default async function DaoOverviewPage({
  params,
}: {
  params: Promise<{ daoId: string }>;
}) {
