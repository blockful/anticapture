...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "text-muted-foreground inline-flex h-full w-full items-center justify-center gap-1 rounded-lg border border-lightDark bg-dark p-1 text-sm font-medium leading-tight text-white text-opacity-50",
      className,
    )}
    {...props}
  />
