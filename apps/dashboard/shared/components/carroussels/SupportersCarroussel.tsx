...
export const SupportersCarroussel = ({
  ...
  return (
    <div className="relative w-full overflow-hidden border-b border-light-dark bg-darkest p-4 sm:rounded-b-lg sm:border-b-0 sm:border-t sm:bg-dark">
      ...
      {/* Left shadow overlay */}
      <div className="absolute left-3 top-0 z-10 h-full w-24 bg-linear-to-r from-darkest to-transparent sm:from-dark" />
      ...
      <div className="absolute right-4 top-0 z-10 h-full w-24 bg-linear-to-l from-darkest to-transparent sm:from-dark" />
    </div>
  );
};
