...
export const GTC: DaoConfiguration = {
  ...
  daoOverview: {
    ...
    cancelFunction: "https://etherscan.io/address/0x57a8865cfB1eCEf7253c27da6B4BC3dAEE5Be518#writeContract#F2",
    rules: {
      delay: true,
      changeVote: false,
      timelock: true,
  ...
  governanceImplementation: {
    ...
    fields: {
      [GovernanceImplementationEnum.AUDITED_CONTRACTS]: {
        ...
        riskExplanation: "The contracts have been audited for smart contract security.",
      },
      ...
      [GovernanceImplementationEnum.ATTACK_PROFITABILITY]: {
        ...
        riskExplanation: "The liquid treasury of the DAO is ~$500k bigger than its current delegated supply..",
      },
      [GovernanceImplementationEnum.PROPOSAL_FLASHLOAN_PROTECTION]: {
        ...
        riskExplanation: "The DAO is not vulnerable to proposal flashloan attacks.",
      },
      [GovernanceImplementationEnum.PROPOSAL_THRESHOLD]: {
        ...
        riskExplanation: "The proposal threshold is 150k GTC, which is the minimum amount of GTC required to propose a new proposal. The level of risk of this depends on the liquidity on markets.",
      },
      [GovernanceImplementationEnum.PROPOSAL_THRESHOLD_CANCEL]: {
        ...
        riskExplanation: "Currently an attacker can propose by holding enough tokens, dump them on the market and the proposal would stay valid.",
      },
      ...
      [GovernanceImplementationEnum.SPAM_RESISTANCE]: {
        ...
        riskExplanation: "Currently, an attacker can submit multiple proposals and cause a war of attrition against defending delegates.",
      },
      [GovernanceImplementationEnum.TIMELOCK_ADMIN]: {
        ...
        riskExplanation: "There's no external entity with control to the timelock roles.",
      },
      [GovernanceImplementationEnum.TIMELOCK_DELAY]: {
        ...
        riskExplanation: "The timelock delay of two days gives time for the DAO to respond before execution.",
      },
      ...
      [GovernanceImplementationEnum.VOTING_DELAY]: {
        ...
        riskExplanation: "With less than 2 days of voting delay, token holders might miss the chance to delegate in support of the DAOs defense",
      },
      ...
      [GovernanceImplementationEnum.VOTING_PERIOD]: {
        ...
        riskExplanation: "The voting period is 5 days and 14 hours, with the recommended safety being of 7 or more for a low level of risk.",
      },
