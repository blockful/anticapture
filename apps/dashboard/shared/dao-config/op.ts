  ...
  governanceImplementation: {
    ...
    fields: {
      [GovernanceImplementationEnum.AUDITED_CONTRACTS]: {
        ...
        riskExplanation: "The contracts, provided by Agora.xyz, have been audited for smart contract security.",
      },
      [GovernanceImplementationEnum.INTERFACE_HIJACK]: {
        ...
        riskExplanation: "The DAO's domains have no publicly verifiable DNS-level protections we are aware of.",
      },
      [GovernanceImplementationEnum.ATTACK_PROFITABILITY]: {
        ...
        riskExplanation: "The DAO has no treasury directly controllable by governance, so there is no way to calculate attack profitability.",
      },
      [GovernanceImplementationEnum.PROPOSAL_FLASHLOAN_PROTECTION]: {
        ...
        riskExplanation: "The Foundation, as manager of the contract, is the only one that can propose, so there's no risk of proposal flashloan attacks.",
      },
      [GovernanceImplementationEnum.PROPOSAL_THRESHOLD]: {
        ...
        riskExplanation: "The proposal threshold is 0, but the propose() function is only callable by the manager, which is the Foundation. All proposals are made in the forum and brought onchain by a centralized manager.",
      },
      [GovernanceImplementationEnum.PROPOSAL_THRESHOLD_CANCEL]: {
        ...
        riskExplanation: "The proposal cancel function is only callable by the manager, which is the Foundation.",
      },
      [GovernanceImplementationEnum.SECURITY_COUNCIL]: {
        ...
        riskExplanation: "The Security Council is elected in 2 separate cohorts of members that are responsible for the security of the DAO. The Security Council is not active on DAO governance, but directly on protocol upgrades.",
      },
      [GovernanceImplementationEnum.SPAM_RESISTANCE]: {
        ...
        riskExplanation: "The Foundation is both the only allowed proposer and the treasury manager, so there's no risk of a spam attack given that any compromise to the foundation would lead directly to a treasury drain.",
      },
      [GovernanceImplementationEnum.TIMELOCK_ADMIN]: {
        ...
        riskExplanation: "The timelock holds no assets and is not used for governance execution.",
      },
      ...
      [GovernanceImplementationEnum.VETO_STRATEGY]: {
        ...
        riskExplanation: "Proposals are not executed by the timelock, but by the Foundation's multisig, so the Foundation can veto proposals by calling the cancel() function during voting, or by just not executing the proposal after approved.",
      },
      [GovernanceImplementationEnum.VOTE_MUTABILITY]: {
        ...
        riskExplanation: "In case of an exploit that affects the voting platforms, immutable votes can leave delegates stuck with a incorrect vote made in a compromised interface.",
      },
      [GovernanceImplementationEnum.VOTING_DELAY]: {
        ...
        riskExplanation: "The Foundation is the only allowed proposer, and it follows a voting schedule, so there's no reason to have a voting delay.",
      },
      [GovernanceImplementationEnum.VOTING_FLASHLOAN_PROTECTION]: {
        ...
        riskExplanation: "Delegates voting power are based on its delegation on block previous to when they could first cast a vote, making flashloan votes impossible.",
      },
      [GovernanceImplementationEnum.VOTING_PERIOD]: {
        ...
        riskExplanation: "The voting period is 6 days, with the recommended safety being of 7 or more for a low level of risk.",
      },
      [GovernanceImplementationEnum.VOTING_SUBSIDY]: {
        ...
        riskExplanation: "The voting subsidy is not applied, requiring delegates to pay gas on the proposals they vote on.",
      },
    },
  },
