...
export type Query = {
  ...
  historicalVotingPower?: Maybe<
    Array<Maybe<Query_HistoricalVotingPower_Items>>
  >;
...
export type AccountPowerFilter = {
  ...
  firstVoteTimestamp_in?: InputMaybe<
  ...
  firstVoteTimestamp_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
...
export type DelegationFilter = {
  ...
  delegateAccountId_in?: InputMaybe<
  ...
  delegateAccountId_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  ...
  delegatedValue_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  delegatorAccountId_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  ...
  delegatorAccountId_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  ...
  previousDelegate_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  ...
  previousDelegate_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
...
export type ProposalsOnchainFilter = {
  ...
  abstainVotes_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  againstVotes_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  daoId?: InputMaybe<Scalars["String"]["input"]>;
  daoId_contains?: InputMaybe<Scalars["String"]["input"]>;
  ...
  proposerAccountId_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
  ...
  proposerAccountId_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
...
export type TokenFilter = {
  ...
  circulatingSupply_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  circulatingSupply_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  delegatedSupply_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  lendingSupply_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
...
export type TransferFilter = {
  ...
  fromAccountId_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
...
export type VotesOnchainFilter = {
  ...
  voterAccountId_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["String"]["input"]>>
  >;
...
export type BalanceHistoryTotalCountQuery = {
  __typename?: "Query";
  transfers: { __typename?: "transferPage"; totalCount: number };
};
...
export type BalanceHistoryBuyQuery = {
  __typename?: "Query";
  transfers: {
    __typename?: "transferPage";
    items: Array<{
...
export type BalanceHistoryBuyTotalCountQuery = {
  __typename?: "Query";
  transfers: { __typename?: "transferPage"; totalCount: number };
};
...
export type BalanceHistorySellQuery = {
  __typename?: "Query";
  transfers: {
    __typename?: "transferPage";
    items: Array<{
...
export type BalanceHistorySellTotalCountQuery = {
  __typename?: "Query";
  transfers: { __typename?: "transferPage"; totalCount: number };
};
...
export type BalanceHistoryGraphQuery = {
  __typename?: "Query";
  transfers: {
    __typename?: "transferPage";
    items: Array<{
...
export type CompareTreasuryQuery = {
  __typename?: "Query";
  compareTreasury?: {
    __typename?: "compareTreasury_200_response";
    changeRate: number;
...
export type VotingPowerVariationsQuery = {
  ...
  votingPowerVariations?: {
    ...
    items: Array<{
      ...
      percentageChange: string;
      previousVotingPower?: string | null;
    } | null>;
  } | null;
};
...
export type GetDelegateDelegationHistoryDeltaRangeQuery = {
  __typename?: "Query";
  votingPowerHistorys: {
    __typename?: "votingPowerHistoryPage";
    totalCount: number;
...
export type GetDelegationsTimestampQuery = {
  __typename?: "Query";
  delegations: {
    __typename?: "delegationPage";
    items: Array<{
...
export type GetTopFiveDelegatorsQuery = {
  __typename?: "Query";
  accountBalances: {
    __typename?: "accountBalancePage";
    items: Array<{
...
export type GetVotingPowerCountingQuery = {
  __typename?: "Query";
  accountBalances: { __typename?: "accountBalancePage"; totalCount: number };
};
...
export type GetVotingPowerChartQuery = {
  __typename?: "Query";
  votingPowers?: {
    __typename?: "votingPowers_200_response";
    items: Array<{
...
export type GetDelegateDelegationHistoryQuery = {
  __typename?: "Query";
  votingPowerHistorys: {
    __typename?: "votingPowerHistoryPage";
    totalCount: number;
...
export type GetDelegatedSupplyHistoryQuery = {
  __typename?: "Query";
...
export type GetDelegatesCountQuery = {
  __typename?: "Query";
  accountPowers: { __typename?: "accountPowerPage"; totalCount: number };
};
...
export type GetHistoricalVotingAndActivityQuery = {
  __typename?: "Query";
  historicalVotingPower?: Array<{
    __typename?: "query_historicalVotingPower_items";
    address: string;
    votingPower: string;
  } | null> | null;
...
export type GetDelegateProposalsActivityQuery = {
  __typename?: "Query";
  proposalsActivity?: {
    __typename?: "proposalsActivity_200_response";
    address: string;
...
export type GetVotesOnchainsQuery = {
  __typename?: "Query";
  votesOnchains: {
    __typename?: "votesOnchainPage";
    totalCount: number;
...
export type GetVotesOnchainsTotalCountQuery = {
  __typename?: "Query";
  votesOnchains: { __typename?: "votesOnchainPage"; totalCount: number };
};
...
export type GetVotingPowerChangeQuery = {
  __typename?: "Query";
  historicalVotingPower?: Array<{
    __typename?: "query_historicalVotingPower_items";
    address: string;
...
export type GetProposalNonVotersQuery = {
  __typename?: "Query";
  proposalNonVoters?: {
    __typename?: "proposalNonVoters_200_response";
    totalCount: number;
...
export type GetAccountPowerQuery = {
  __typename?: "Query";
  accountPower?: {
    __typename?: "accountPower";
    votingPower: any;
...
export type GetProposalsActivityQuery = {
  __typename?: "Query";
  proposalsActivity?: {
    __typename?: "proposalsActivity_200_response";
    totalProposals: number;
...
export type GetDaoAddressesAccountBalancesQuery = {
  __typename?: "Query";
  accountBalances: {
    __typename?: "accountBalancePage";
    items: Array<{
...
export type GetDelegationHistoryCountQuery = {
  __typename?: "Query";
  delegations: { __typename?: "delegationPage"; totalCount: number };
};
...
export type GetTopTokenHoldersQuery = {
  __typename?: "Query";
  accountBalances: {
    __typename?: "accountBalancePage";
    items: Array<{
...
export type GetTokenHoldersCoutingQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetTokenHoldersCoutingQuery = {
  __typename?: "Query";
  accountBalances: { __typename?: "accountBalancePage"; totalCount: number };
};
...
export function useBalanceHistoryQuery(
  ...
  return Apollo.useQuery<BalanceHistoryQuery, BalanceHistoryQueryVariables>(
    BalanceHistoryDocument,
    options,
  );
}
export function useBalanceHistoryLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<BalanceHistoryQuery, BalanceHistoryQueryVariables>(
    BalanceHistoryDocument,
    options,
  );
}
export function useBalanceHistorySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
  ...
  return Apollo.useSuspenseQuery<
    BalanceHistoryQuery,
    BalanceHistoryQueryVariables
  >(BalanceHistoryDocument, options);
}
export type BalanceHistoryQueryHookResult = ReturnType<
  typeof useBalanceHistoryQuery
>;
export type BalanceHistoryLazyQueryHookResult = ReturnType<
  typeof useBalanceHistoryLazyQuery
>;
export type BalanceHistorySuspenseQueryHookResult = ReturnType<
  typeof useBalanceHistorySuspenseQuery
>;
export type BalanceHistoryQueryResult = Apollo.QueryResult<
  BalanceHistoryQuery,
  BalanceHistoryQueryVariables
>;
 ...
 * });
 */
export function useBalanceHistoryTotalCountQuery(
  baseOptions: Apollo.QueryHookOptions<
    BalanceHistoryTotalCountQuery,
    BalanceHistoryTotalCountQueryVariables
  > &
    (
      | { variables: BalanceHistoryTotalCountQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    BalanceHistoryTotalCountQuery,
    BalanceHistoryTotalCountQueryVariables
  >(BalanceHistoryTotalCountDocument, options);
}
export function useBalanceHistoryTotalCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BalanceHistoryTotalCountQuery,
    BalanceHistoryTotalCountQueryVariables
  >,
...
export function useBalanceHistoryTotalCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        BalanceHistoryTotalCountQuery,
...
export type BalanceHistoryTotalCountQueryHookResult = ReturnType<
  typeof useBalanceHistoryTotalCountQuery
>;
export type BalanceHistoryTotalCountLazyQueryHookResult = ReturnType<
  typeof useBalanceHistoryTotalCountLazyQuery
>;
export type BalanceHistoryTotalCountSuspenseQueryHookResult = ReturnType<
  typeof useBalanceHistoryTotalCountSuspenseQuery
>;
export type BalanceHistoryTotalCountQueryResult = Apollo.QueryResult<
  BalanceHistoryTotalCountQuery,
  BalanceHistoryTotalCountQueryVariables
>;
export const BalanceHistoryBuyDocument = gql`
  query BalanceHistoryBuy(
    $account: String!
    $after: String
    $before: String
    $limit: Int = 10
 ...
 * });
 */
export function useBalanceHistoryBuyQuery(
  baseOptions: Apollo.QueryHookOptions<
    BalanceHistoryBuyQuery,
    BalanceHistoryBuyQueryVariables
  > &
    (
      | { variables: BalanceHistoryBuyQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    BalanceHistoryBuyQuery,
    BalanceHistoryBuyQueryVariables
  >(BalanceHistoryBuyDocument, options);
}
export function useBalanceHistoryBuyLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BalanceHistoryBuyQuery,
    BalanceHistoryBuyQueryVariables
  >,
...
export function useBalanceHistoryBuySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        BalanceHistoryBuyQuery,
...
export type BalanceHistoryBuyQueryHookResult = ReturnType<
  typeof useBalanceHistoryBuyQuery
>;
export type BalanceHistoryBuyLazyQueryHookResult = ReturnType<
  typeof useBalanceHistoryBuyLazyQuery
>;
export type BalanceHistoryBuySuspenseQueryHookResult = ReturnType<
  typeof useBalanceHistoryBuySuspenseQuery
>;
export type BalanceHistoryBuyQueryResult = Apollo.QueryResult<
  BalanceHistoryBuyQuery,
  BalanceHistoryBuyQueryVariables
>;
 ...
 * });
 */
export function useBalanceHistoryBuyTotalCountQuery(
  baseOptions: Apollo.QueryHookOptions<
    BalanceHistoryBuyTotalCountQuery,
    BalanceHistoryBuyTotalCountQueryVariables
  > &
    (
      | { variables: BalanceHistoryBuyTotalCountQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    BalanceHistoryBuyTotalCountQuery,
    BalanceHistoryBuyTotalCountQueryVariables
  >(BalanceHistoryBuyTotalCountDocument, options);
}
export function useBalanceHistoryBuyTotalCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BalanceHistoryBuyTotalCountQuery,
    BalanceHistoryBuyTotalCountQueryVariables
  >,
...
export function useBalanceHistoryBuyTotalCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        BalanceHistoryBuyTotalCountQuery,
...
export type BalanceHistoryBuyTotalCountQueryHookResult = ReturnType<
  typeof useBalanceHistoryBuyTotalCountQuery
>;
export type BalanceHistoryBuyTotalCountLazyQueryHookResult = ReturnType<
  typeof useBalanceHistoryBuyTotalCountLazyQuery
>;
export type BalanceHistoryBuyTotalCountSuspenseQueryHookResult = ReturnType<
  typeof useBalanceHistoryBuyTotalCountSuspenseQuery
>;
export type BalanceHistoryBuyTotalCountQueryResult = Apollo.QueryResult<
  BalanceHistoryBuyTotalCountQuery,
  BalanceHistoryBuyTotalCountQueryVariables
>;
export const BalanceHistorySellDocument = gql`
  query BalanceHistorySell(
    $account: String!
    $after: String
    $before: String
    $limit: Int = 10
 ...
 * });
 */
export function useBalanceHistorySellQuery(
  baseOptions: Apollo.QueryHookOptions<
    BalanceHistorySellQuery,
    BalanceHistorySellQueryVariables
  > &
    (
      | { variables: BalanceHistorySellQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    BalanceHistorySellQuery,
    BalanceHistorySellQueryVariables
  >(BalanceHistorySellDocument, options);
}
export function useBalanceHistorySellLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BalanceHistorySellQuery,
    BalanceHistorySellQueryVariables
  >,
...
export function useBalanceHistorySellSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        BalanceHistorySellQuery,
...
export type BalanceHistorySellQueryHookResult = ReturnType<
  typeof useBalanceHistorySellQuery
>;
export type BalanceHistorySellLazyQueryHookResult = ReturnType<
  typeof useBalanceHistorySellLazyQuery
>;
export type BalanceHistorySellSuspenseQueryHookResult = ReturnType<
  typeof useBalanceHistorySellSuspenseQuery
>;
export type BalanceHistorySellQueryResult = Apollo.QueryResult<
  BalanceHistorySellQuery,
  BalanceHistorySellQueryVariables
>;
 ...
 * });
 */
export function useBalanceHistorySellTotalCountQuery(
  baseOptions: Apollo.QueryHookOptions<
    BalanceHistorySellTotalCountQuery,
    BalanceHistorySellTotalCountQueryVariables
  > &
    (
      | {
          variables: BalanceHistorySellTotalCountQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    BalanceHistorySellTotalCountQuery,
    BalanceHistorySellTotalCountQueryVariables
  >(BalanceHistorySellTotalCountDocument, options);
}
export function useBalanceHistorySellTotalCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BalanceHistorySellTotalCountQuery,
    BalanceHistorySellTotalCountQueryVariables
  >,
...
export function useBalanceHistorySellTotalCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        BalanceHistorySellTotalCountQuery,
...
export type BalanceHistorySellTotalCountQueryHookResult = ReturnType<
  typeof useBalanceHistorySellTotalCountQuery
>;
export type BalanceHistorySellTotalCountLazyQueryHookResult = ReturnType<
  typeof useBalanceHistorySellTotalCountLazyQuery
>;
export type BalanceHistorySellTotalCountSuspenseQueryHookResult = ReturnType<
  typeof useBalanceHistorySellTotalCountSuspenseQuery
>;
export type BalanceHistorySellTotalCountQueryResult = Apollo.QueryResult<
  BalanceHistorySellTotalCountQuery,
  BalanceHistorySellTotalCountQueryVariables
>;
export const BalanceHistoryGraphDocument = gql`
  query BalanceHistoryGraph(
    $accountId: String!
    $orderBy: String = "timestamp"
    $orderDirection: String = "desc"
 ...
 * });
 */
export function useBalanceHistoryGraphQuery(
  baseOptions: Apollo.QueryHookOptions<
    BalanceHistoryGraphQuery,
    BalanceHistoryGraphQueryVariables
  > &
    (
      | { variables: BalanceHistoryGraphQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    BalanceHistoryGraphQuery,
    BalanceHistoryGraphQueryVariables
  >(BalanceHistoryGraphDocument, options);
}
export function useBalanceHistoryGraphLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BalanceHistoryGraphQuery,
    BalanceHistoryGraphQueryVariables
  >,
...
export function useBalanceHistoryGraphSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        BalanceHistoryGraphQuery,
...
export type BalanceHistoryGraphQueryHookResult = ReturnType<
  typeof useBalanceHistoryGraphQuery
>;
export type BalanceHistoryGraphLazyQueryHookResult = ReturnType<
  typeof useBalanceHistoryGraphLazyQuery
>;
export type BalanceHistoryGraphSuspenseQueryHookResult = ReturnType<
  typeof useBalanceHistoryGraphSuspenseQuery
>;
export type BalanceHistoryGraphQueryResult = Apollo.QueryResult<
  BalanceHistoryGraphQuery,
  BalanceHistoryGraphQueryVariables
>;
export const AccountBalanceVariationsDocument = gql`
  query AccountBalanceVariations(
    $days: queryInput_accountBalanceVariations_days!
 ...
 * });
 */
export function useAccountBalanceVariationsQuery(
  baseOptions: Apollo.QueryHookOptions<
    AccountBalanceVariationsQuery,
    AccountBalanceVariationsQueryVariables
  > &
    (
      | { variables: AccountBalanceVariationsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    AccountBalanceVariationsQuery,
    AccountBalanceVariationsQueryVariables
  >(AccountBalanceVariationsDocument, options);
}
export function useAccountBalanceVariationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    AccountBalanceVariationsQuery,
    AccountBalanceVariationsQueryVariables
  >,
...
export function useAccountBalanceVariationsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        AccountBalanceVariationsQuery,
...
export type AccountBalanceVariationsQueryHookResult = ReturnType<
  typeof useAccountBalanceVariationsQuery
>;
export type AccountBalanceVariationsLazyQueryHookResult = ReturnType<
  typeof useAccountBalanceVariationsLazyQuery
>;
export type AccountBalanceVariationsSuspenseQueryHookResult = ReturnType<
  typeof useAccountBalanceVariationsSuspenseQuery
>;
export type AccountBalanceVariationsQueryResult = Apollo.QueryResult<
  AccountBalanceVariationsQuery,
  AccountBalanceVariationsQueryVariables
>;
 ...
 * });
 */
export function useCompareTreasuryQuery(
  baseOptions: Apollo.QueryHookOptions<
    CompareTreasuryQuery,
    CompareTreasuryQueryVariables
  > &
    (
      | { variables: CompareTreasuryQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CompareTreasuryQuery, CompareTreasuryQueryVariables>(
    CompareTreasuryDocument,
    options,
  );
}
export function useCompareTreasuryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    CompareTreasuryQuery,
    CompareTreasuryQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    CompareTreasuryQuery,
    CompareTreasuryQueryVariables
  >(CompareTreasuryDocument, options);
}
export function useCompareTreasurySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        CompareTreasuryQuery,
...
export type CompareTreasuryQueryHookResult = ReturnType<
  typeof useCompareTreasuryQuery
>;
export type CompareTreasuryLazyQueryHookResult = ReturnType<
  typeof useCompareTreasuryLazyQuery
>;
export type CompareTreasurySuspenseQueryHookResult = ReturnType<
  typeof useCompareTreasurySuspenseQuery
>;
export type CompareTreasuryQueryResult = Apollo.QueryResult<
  CompareTreasuryQuery,
  CompareTreasuryQueryVariables
>;
export const VotingPowerVariationsDocument = gql`
  query VotingPowerVariations(
    $days: queryInput_votingPowerVariations_days!
    $limit: PositiveInt = 10
  ) {
 ...
 * });
 */
export function useVotingPowerVariationsQuery(
  baseOptions: Apollo.QueryHookOptions<
    VotingPowerVariationsQuery,
    VotingPowerVariationsQueryVariables
  > &
    (
      | { variables: VotingPowerVariationsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    VotingPowerVariationsQuery,
    VotingPowerVariationsQueryVariables
  >(VotingPowerVariationsDocument, options);
}
export function useVotingPowerVariationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    VotingPowerVariationsQuery,
    VotingPowerVariationsQueryVariables
  >,
...
export function useVotingPowerVariationsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        VotingPowerVariationsQuery,
...
export type VotingPowerVariationsQueryHookResult = ReturnType<
  typeof useVotingPowerVariationsQuery
>;
export type VotingPowerVariationsLazyQueryHookResult = ReturnType<
  typeof useVotingPowerVariationsLazyQuery
>;
export type VotingPowerVariationsSuspenseQueryHookResult = ReturnType<
  typeof useVotingPowerVariationsSuspenseQuery
>;
export type VotingPowerVariationsQueryResult = Apollo.QueryResult<
  VotingPowerVariationsQuery,
  VotingPowerVariationsQueryVariables
>;
 ...
 * });
 */
export function useGetDaoDataQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetDaoDataQuery,
    GetDaoDataQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetDaoDataQuery, GetDaoDataQueryVariables>(
    GetDaoDataDocument,
    options,
  );
}
export function useGetDaoDataLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDaoDataQuery,
    GetDaoDataQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetDaoDataQuery, GetDaoDataQueryVariables>(
    GetDaoDataDocument,
    options,
  );
}
export function useGetDaoDataSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDaoDataQuery,
  ...
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetDaoDataQuery, GetDaoDataQueryVariables>(
    GetDaoDataDocument,
    options,
  );
}
export type GetDaoDataQueryHookResult = ReturnType<typeof useGetDaoDataQuery>;
export type GetDaoDataLazyQueryHookResult = ReturnType<
  typeof useGetDaoDataLazyQuery
>;
export type GetDaoDataSuspenseQueryHookResult = ReturnType<
  typeof useGetDaoDataSuspenseQuery
>;
export type GetDaoDataQueryResult = Apollo.QueryResult<
  GetDaoDataQuery,
  GetDaoDataQueryVariables
>;
...
export const GetDelegateDelegationHistoryDeltaRangeDocument = gql`
  query GetDelegateDelegationHistoryDeltaRange(
    $accountId: String!
    $deltaMod_gte: BigInt
    $deltaMod_lte: BigInt
    $orderBy: String = "timestamp"
    ...
    votingPowerHistorys(
      ...
      where: {
        accountId: $accountId
        deltaMod_gte: $deltaMod_gte
        deltaMod_lte: $deltaMod_lte
      }
      limit: $limit
      after: $after
      before: $before
...
/**
 * __useGetDelegateDelegationHistoryDeltaRangeQuery__
 *
 * To run a query within a React component, call `useGetDelegateDelegationHistoryDeltaRangeQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetDelegateDelegationHistoryDeltaRangeQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetDelegateDelegationHistoryDeltaRangeQuery({
 *   variables: {
 *      accountId: // value for 'accountId'
 *      deltaMod_gte: // value for 'deltaMod_gte'
 *      deltaMod_lte: // value for 'deltaMod_lte'
 *      orderBy: // value for 'orderBy'
 *      orderDirection: // value for 'orderDirection'
 *      limit: // value for 'limit'
 *      after: // value for 'after'
 ...
 * });
 */
export function useGetDelegateDelegationHistoryDeltaRangeQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegateDelegationHistoryDeltaRangeQuery,
    GetDelegateDelegationHistoryDeltaRangeQueryVariables
  > &
    (
      | {
          variables: GetDelegateDelegationHistoryDeltaRangeQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    GetDelegateDelegationHistoryDeltaRangeQuery,
    GetDelegateDelegationHistoryDeltaRangeQueryVariables
  >(GetDelegateDelegationHistoryDeltaRangeDocument, options);
}
export function useGetDelegateDelegationHistoryDeltaRangeLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegateDelegationHistoryDeltaRangeQuery,
    GetDelegateDelegationHistoryDeltaRangeQueryVariables
  >,
...
export function useGetDelegateDelegationHistoryDeltaRangeSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegateDelegationHistoryDeltaRangeQuery,
...
export type GetDelegateDelegationHistoryDeltaRangeQueryHookResult = ReturnType<
  typeof useGetDelegateDelegationHistoryDeltaRangeQuery
>;
export type GetDelegateDelegationHistoryDeltaRangeLazyQueryHookResult =
  ReturnType<typeof useGetDelegateDelegationHistoryDeltaRangeLazyQuery>;
export type GetDelegateDelegationHistoryDeltaRangeSuspenseQueryHookResult =
  ReturnType<typeof useGetDelegateDelegationHistoryDeltaRangeSuspenseQuery>;
export type GetDelegateDelegationHistoryDeltaRangeQueryResult =
  Apollo.QueryResult<
    GetDelegateDelegationHistoryDeltaRangeQuery,
    GetDelegateDelegationHistoryDeltaRangeQueryVariables
  >;
export const GetDelegatorVotingPowerDetailsDocument = gql`
  query GetDelegatorVotingPowerDetails(
    $address: String!
    $after: String
    $before: String
    $orderBy: String
 ...
 * });
 */
export function useGetDelegatorVotingPowerDetailsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegatorVotingPowerDetailsQuery,
    GetDelegatorVotingPowerDetailsQueryVariables
  > &
    (
      | {
          variables: GetDelegatorVotingPowerDetailsQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    GetDelegatorVotingPowerDetailsQuery,
    GetDelegatorVotingPowerDetailsQueryVariables
  >(GetDelegatorVotingPowerDetailsDocument, options);
}
export function useGetDelegatorVotingPowerDetailsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegatorVotingPowerDetailsQuery,
    GetDelegatorVotingPowerDetailsQueryVariables
  >,
...
export function useGetDelegatorVotingPowerDetailsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegatorVotingPowerDetailsQuery,
...
export type GetDelegatorVotingPowerDetailsQueryHookResult = ReturnType<
  typeof useGetDelegatorVotingPowerDetailsQuery
>;
export type GetDelegatorVotingPowerDetailsLazyQueryHookResult = ReturnType<
  typeof useGetDelegatorVotingPowerDetailsLazyQuery
>;
export type GetDelegatorVotingPowerDetailsSuspenseQueryHookResult = ReturnType<
  typeof useGetDelegatorVotingPowerDetailsSuspenseQuery
>;
export type GetDelegatorVotingPowerDetailsQueryResult = Apollo.QueryResult<
  GetDelegatorVotingPowerDetailsQuery,
  GetDelegatorVotingPowerDetailsQueryVariables
>;
export const GetDelegationsTimestampDocument = gql`
  query getDelegationsTimestamp(
    $delegator: [String!]!
    $delegate: String!
    $daoId: String!
  ) {
 ...
 * });
 */
export function useGetDelegationsTimestampQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegationsTimestampQuery,
    GetDelegationsTimestampQueryVariables
  > &
    (
      | { variables: GetDelegationsTimestampQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetDelegationsTimestampQuery,
    GetDelegationsTimestampQueryVariables
  >(GetDelegationsTimestampDocument, options);
}
export function useGetDelegationsTimestampLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegationsTimestampQuery,
    GetDelegationsTimestampQueryVariables
  >,
...
export function useGetDelegationsTimestampSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegationsTimestampQuery,
...
export type GetDelegationsTimestampQueryHookResult = ReturnType<
  typeof useGetDelegationsTimestampQuery
>;
export type GetDelegationsTimestampLazyQueryHookResult = ReturnType<
  typeof useGetDelegationsTimestampLazyQuery
>;
export type GetDelegationsTimestampSuspenseQueryHookResult = ReturnType<
  typeof useGetDelegationsTimestampSuspenseQuery
>;
export type GetDelegationsTimestampQueryResult = Apollo.QueryResult<
  GetDelegationsTimestampQuery,
  GetDelegationsTimestampQueryVariables
>;
 ...
 * });
 */
export function useGetTopFiveDelegatorsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetTopFiveDelegatorsQuery,
    GetTopFiveDelegatorsQueryVariables
  > &
    (
      | { variables: GetTopFiveDelegatorsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetTopFiveDelegatorsQuery,
    GetTopFiveDelegatorsQueryVariables
  >(GetTopFiveDelegatorsDocument, options);
}
export function useGetTopFiveDelegatorsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTopFiveDelegatorsQuery,
    GetTopFiveDelegatorsQueryVariables
  >,
...
export function useGetTopFiveDelegatorsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetTopFiveDelegatorsQuery,
...
export type GetTopFiveDelegatorsQueryHookResult = ReturnType<
  typeof useGetTopFiveDelegatorsQuery
>;
export type GetTopFiveDelegatorsLazyQueryHookResult = ReturnType<
  typeof useGetTopFiveDelegatorsLazyQuery
>;
export type GetTopFiveDelegatorsSuspenseQueryHookResult = ReturnType<
  typeof useGetTopFiveDelegatorsSuspenseQuery
>;
export type GetTopFiveDelegatorsQueryResult = Apollo.QueryResult<
  GetTopFiveDelegatorsQuery,
  GetTopFiveDelegatorsQueryVariables
>;
 ...
 * });
 */
export function useGetVotingPowerCountingQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetVotingPowerCountingQuery,
    GetVotingPowerCountingQueryVariables
  > &
    (
      | { variables: GetVotingPowerCountingQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetVotingPowerCountingQuery,
    GetVotingPowerCountingQueryVariables
  >(GetVotingPowerCountingDocument, options);
}
export function useGetVotingPowerCountingLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetVotingPowerCountingQuery,
    GetVotingPowerCountingQueryVariables
  >,
...
export function useGetVotingPowerCountingSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetVotingPowerCountingQuery,
...
export type GetVotingPowerCountingQueryHookResult = ReturnType<
  typeof useGetVotingPowerCountingQuery
>;
export type GetVotingPowerCountingLazyQueryHookResult = ReturnType<
  typeof useGetVotingPowerCountingLazyQuery
>;
export type GetVotingPowerCountingSuspenseQueryHookResult = ReturnType<
  typeof useGetVotingPowerCountingSuspenseQuery
>;
export type GetVotingPowerCountingQueryResult = Apollo.QueryResult<
  GetVotingPowerCountingQuery,
  GetVotingPowerCountingQueryVariables
>;
export const GetVotingPowerChartDocument = gql`
  query GetVotingPowerChart(
    $account: String!
    $limit: PositiveInt = 10
 ...
 * });
 */
export function useGetVotingPowerChartQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetVotingPowerChartQuery,
    GetVotingPowerChartQueryVariables
  > &
    (
      | { variables: GetVotingPowerChartQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetVotingPowerChartQuery,
    GetVotingPowerChartQueryVariables
  >(GetVotingPowerChartDocument, options);
}
export function useGetVotingPowerChartLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetVotingPowerChartQuery,
    GetVotingPowerChartQueryVariables
  >,
...
export function useGetVotingPowerChartSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetVotingPowerChartQuery,
...
export type GetVotingPowerChartQueryHookResult = ReturnType<
  typeof useGetVotingPowerChartQuery
>;
export type GetVotingPowerChartLazyQueryHookResult = ReturnType<
  typeof useGetVotingPowerChartLazyQuery
>;
export type GetVotingPowerChartSuspenseQueryHookResult = ReturnType<
  typeof useGetVotingPowerChartSuspenseQuery
>;
export type GetVotingPowerChartQueryResult = Apollo.QueryResult<
  GetVotingPowerChartQuery,
  GetVotingPowerChartQueryVariables
>;
 ...
 * });
 */
export function useGetDelegateDelegationHistoryQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegateDelegationHistoryQuery,
    GetDelegateDelegationHistoryQueryVariables
  > &
    (
      | {
          variables: GetDelegateDelegationHistoryQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    GetDelegateDelegationHistoryQuery,
    GetDelegateDelegationHistoryQueryVariables
  >(GetDelegateDelegationHistoryDocument, options);
}
export function useGetDelegateDelegationHistoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegateDelegationHistoryQuery,
    GetDelegateDelegationHistoryQueryVariables
  >,
...
export function useGetDelegateDelegationHistorySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegateDelegationHistoryQuery,
...
export type GetDelegateDelegationHistoryQueryHookResult = ReturnType<
  typeof useGetDelegateDelegationHistoryQuery
>;
export type GetDelegateDelegationHistoryLazyQueryHookResult = ReturnType<
  typeof useGetDelegateDelegationHistoryLazyQuery
>;
export type GetDelegateDelegationHistorySuspenseQueryHookResult = ReturnType<
  typeof useGetDelegateDelegationHistorySuspenseQuery
>;
export type GetDelegateDelegationHistoryQueryResult = Apollo.QueryResult<
  GetDelegateDelegationHistoryQuery,
  GetDelegateDelegationHistoryQueryVariables
>;
 ...
 * });
 */
export function useGetDelegateDelegationHistoryGraphQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegateDelegationHistoryGraphQuery,
    GetDelegateDelegationHistoryGraphQueryVariables
  > &
    (
      | {
          variables: GetDelegateDelegationHistoryGraphQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    GetDelegateDelegationHistoryGraphQuery,
    GetDelegateDelegationHistoryGraphQueryVariables
  >(GetDelegateDelegationHistoryGraphDocument, options);
}
export function useGetDelegateDelegationHistoryGraphLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegateDelegationHistoryGraphQuery,
    GetDelegateDelegationHistoryGraphQueryVariables
  >,
...
export function useGetDelegateDelegationHistoryGraphSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegateDelegationHistoryGraphQuery,
...
export type GetDelegateDelegationHistoryGraphQueryHookResult = ReturnType<
  typeof useGetDelegateDelegationHistoryGraphQuery
>;
export type GetDelegateDelegationHistoryGraphLazyQueryHookResult = ReturnType<
  typeof useGetDelegateDelegationHistoryGraphLazyQuery
>;
export type GetDelegateDelegationHistoryGraphSuspenseQueryHookResult =
  ReturnType<typeof useGetDelegateDelegationHistoryGraphSuspenseQuery>;
export type GetDelegateDelegationHistoryGraphQueryResult = Apollo.QueryResult<
  GetDelegateDelegationHistoryGraphQuery,
  GetDelegateDelegationHistoryGraphQueryVariables
>;
export const GetDelegatedSupplyHistoryDocument = gql`
  query GetDelegatedSupplyHistory($startDate: String!, $endDate: String) {
    averageDelegationPercentageByDay(
      startDate: $startDate
      endDate: $endDate
      limit: 365
...
/**
 * __useGetDelegatedSupplyHistoryQuery__
 *
 * To run a query within a React component, call `useGetDelegatedSupplyHistoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetDelegatedSupplyHistoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetDelegatedSupplyHistoryQuery({
 *   variables: {
 ...
 * });
 */
export function useGetDelegatedSupplyHistoryQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegatedSupplyHistoryQuery,
    GetDelegatedSupplyHistoryQueryVariables
  > &
    (
      | { variables: GetDelegatedSupplyHistoryQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetDelegatedSupplyHistoryQuery,
    GetDelegatedSupplyHistoryQueryVariables
  >(GetDelegatedSupplyHistoryDocument, options);
}
export function useGetDelegatedSupplyHistoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegatedSupplyHistoryQuery,
    GetDelegatedSupplyHistoryQueryVariables
  >,
...
export function useGetDelegatedSupplyHistorySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegatedSupplyHistoryQuery,
...
export type GetDelegatedSupplyHistoryQueryHookResult = ReturnType<
  typeof useGetDelegatedSupplyHistoryQuery
>;
export type GetDelegatedSupplyHistoryLazyQueryHookResult = ReturnType<
  typeof useGetDelegatedSupplyHistoryLazyQuery
>;
export type GetDelegatedSupplyHistorySuspenseQueryHookResult = ReturnType<
  typeof useGetDelegatedSupplyHistorySuspenseQuery
>;
export type GetDelegatedSupplyHistoryQueryResult = Apollo.QueryResult<
  GetDelegatedSupplyHistoryQuery,
  GetDelegatedSupplyHistoryQueryVariables
>;
 ...
 * });
 */
export function useGetDelegatesCountQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetDelegatesCountQuery,
    GetDelegatesCountQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetDelegatesCountQuery,
    GetDelegatesCountQueryVariables
  >(GetDelegatesCountDocument, options);
}
export function useGetDelegatesCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegatesCountQuery,
    GetDelegatesCountQueryVariables
  >,
...
export function useGetDelegatesCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegatesCountQuery,
...
export type GetDelegatesCountQueryHookResult = ReturnType<
  typeof useGetDelegatesCountQuery
>;
export type GetDelegatesCountLazyQueryHookResult = ReturnType<
  typeof useGetDelegatesCountLazyQuery
>;
export type GetDelegatesCountSuspenseQueryHookResult = ReturnType<
  typeof useGetDelegatesCountSuspenseQuery
>;
export type GetDelegatesCountQueryResult = Apollo.QueryResult<
  GetDelegatesCountQuery,
  GetDelegatesCountQueryVariables
>;
export const GetHistoricalVotingAndActivityDocument = gql`
  query GetHistoricalVotingAndActivity(
    $addresses: JSON!
    $address: String!
    $days: queryInput_historicalVotingPower_days!
 ...
 * });
 */
export function useGetHistoricalVotingAndActivityQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetHistoricalVotingAndActivityQuery,
    GetHistoricalVotingAndActivityQueryVariables
  > &
    (
      | {
          variables: GetHistoricalVotingAndActivityQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    GetHistoricalVotingAndActivityQuery,
    GetHistoricalVotingAndActivityQueryVariables
  >(GetHistoricalVotingAndActivityDocument, options);
}
export function useGetHistoricalVotingAndActivityLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetHistoricalVotingAndActivityQuery,
    GetHistoricalVotingAndActivityQueryVariables
  >,
...
export function useGetHistoricalVotingAndActivitySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetHistoricalVotingAndActivityQuery,
...
export type GetHistoricalVotingAndActivityQueryHookResult = ReturnType<
  typeof useGetHistoricalVotingAndActivityQuery
>;
export type GetHistoricalVotingAndActivityLazyQueryHookResult = ReturnType<
  typeof useGetHistoricalVotingAndActivityLazyQuery
>;
export type GetHistoricalVotingAndActivitySuspenseQueryHookResult = ReturnType<
  typeof useGetHistoricalVotingAndActivitySuspenseQuery
>;
export type GetHistoricalVotingAndActivityQueryResult = Apollo.QueryResult<
  GetHistoricalVotingAndActivityQuery,
  GetHistoricalVotingAndActivityQueryVariables
>;
export const GetDelegateProposalsActivityDocument = gql`
  query GetDelegateProposalsActivity(
    $address: String!
    $fromDate: NonNegativeInt
  ) {
    proposalsActivity(address: $address, fromDate: $fromDate) {
 ...
 * });
 */
export function useGetDelegateProposalsActivityQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegateProposalsActivityQuery,
    GetDelegateProposalsActivityQueryVariables
  > &
    (
      | {
          variables: GetDelegateProposalsActivityQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    GetDelegateProposalsActivityQuery,
    GetDelegateProposalsActivityQueryVariables
  >(GetDelegateProposalsActivityDocument, options);
}
export function useGetDelegateProposalsActivityLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegateProposalsActivityQuery,
    GetDelegateProposalsActivityQueryVariables
  >,
...
export function useGetDelegateProposalsActivitySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegateProposalsActivityQuery,
...
export type GetDelegateProposalsActivityQueryHookResult = ReturnType<
  typeof useGetDelegateProposalsActivityQuery
>;
export type GetDelegateProposalsActivityLazyQueryHookResult = ReturnType<
  typeof useGetDelegateProposalsActivityLazyQuery
>;
export type GetDelegateProposalsActivitySuspenseQueryHookResult = ReturnType<
  typeof useGetDelegateProposalsActivitySuspenseQuery
>;
export type GetDelegateProposalsActivityQueryResult = Apollo.QueryResult<
  GetDelegateProposalsActivityQuery,
  GetDelegateProposalsActivityQueryVariables
>;
...
/**
 * __useGetProposalsFromDaoQuery__
 *
 * To run a query within a React component, call `useGetProposalsFromDaoQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProposalsFromDaoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetProposalsFromDaoQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetProposalsFromDaoQuery,
    GetProposalsFromDaoQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetProposalsFromDaoQuery,
    GetProposalsFromDaoQueryVariables
  >(GetProposalsFromDaoDocument, options);
}
export function useGetProposalsFromDaoLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetProposalsFromDaoQuery,
    GetProposalsFromDaoQueryVariables
  >,
...
export function useGetProposalsFromDaoSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetProposalsFromDaoQuery,
...
export type GetProposalsFromDaoQueryHookResult = ReturnType<
  typeof useGetProposalsFromDaoQuery
>;
export type GetProposalsFromDaoLazyQueryHookResult = ReturnType<
  typeof useGetProposalsFromDaoLazyQuery
>;
export type GetProposalsFromDaoSuspenseQueryHookResult = ReturnType<
  typeof useGetProposalsFromDaoSuspenseQuery
>;
export type GetProposalsFromDaoQueryResult = Apollo.QueryResult<
  GetProposalsFromDaoQuery,
  GetProposalsFromDaoQueryVariables
>;
 ...
 * });
 */
export function useGetVotesOnchainsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetVotesOnchainsQuery,
    GetVotesOnchainsQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetVotesOnchainsQuery, GetVotesOnchainsQueryVariables>(
    GetVotesOnchainsDocument,
    options,
  );
}
export function useGetVotesOnchainsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetVotesOnchainsQuery,
    GetVotesOnchainsQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    GetVotesOnchainsQuery,
    GetVotesOnchainsQueryVariables
  >(GetVotesOnchainsDocument, options);
}
export function useGetVotesOnchainsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetVotesOnchainsQuery,
...
export type GetVotesOnchainsQueryHookResult = ReturnType<
  typeof useGetVotesOnchainsQuery
>;
export type GetVotesOnchainsLazyQueryHookResult = ReturnType<
  typeof useGetVotesOnchainsLazyQuery
>;
export type GetVotesOnchainsSuspenseQueryHookResult = ReturnType<
  typeof useGetVotesOnchainsSuspenseQuery
>;
export type GetVotesOnchainsQueryResult = Apollo.QueryResult<
  GetVotesOnchainsQuery,
  GetVotesOnchainsQueryVariables
>;
export const GetVotesOnchainsTotalCountDocument = gql`
...
/**
 * __useGetVotesOnchainsTotalCountQuery__
 *
 * To run a query within a React component, call `useGetVotesOnchainsTotalCountQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetVotesOnchainsTotalCountQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetVotesOnchainsTotalCountQuery({
 *   variables: {
 *      proposalId: // value for 'proposalId'
 *   },
 * });
 */
export function useGetVotesOnchainsTotalCountQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetVotesOnchainsTotalCountQuery,
    GetVotesOnchainsTotalCountQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetVotesOnchainsTotalCountQuery,
    GetVotesOnchainsTotalCountQueryVariables
  >(GetVotesOnchainsTotalCountDocument, options);
}
export function useGetVotesOnchainsTotalCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetVotesOnchainsTotalCountQuery,
    GetVotesOnchainsTotalCountQueryVariables
  >,
...
export function useGetVotesOnchainsTotalCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetVotesOnchainsTotalCountQuery,
...
export type GetVotesOnchainsTotalCountQueryHookResult = ReturnType<
  typeof useGetVotesOnchainsTotalCountQuery
>;
export type GetVotesOnchainsTotalCountLazyQueryHookResult = ReturnType<
  typeof useGetVotesOnchainsTotalCountLazyQuery
>;
export type GetVotesOnchainsTotalCountSuspenseQueryHookResult = ReturnType<
  typeof useGetVotesOnchainsTotalCountSuspenseQuery
>;
export type GetVotesOnchainsTotalCountQueryResult = Apollo.QueryResult<
  GetVotesOnchainsTotalCountQuery,
  GetVotesOnchainsTotalCountQueryVariables
>;
...
/**
 * __useGetVotingPowerChangeQuery__
 *
 * To run a query within a React component, call `useGetVotingPowerChangeQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetVotingPowerChangeQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetVotingPowerChangeQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetVotingPowerChangeQuery,
    GetVotingPowerChangeQueryVariables
  > &
    (
      | { variables: GetVotingPowerChangeQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetVotingPowerChangeQuery,
    GetVotingPowerChangeQueryVariables
  >(GetVotingPowerChangeDocument, options);
}
export function useGetVotingPowerChangeLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetVotingPowerChangeQuery,
    GetVotingPowerChangeQueryVariables
  >,
...
export function useGetVotingPowerChangeSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetVotingPowerChangeQuery,
...
export type GetVotingPowerChangeQueryHookResult = ReturnType<
  typeof useGetVotingPowerChangeQuery
>;
export type GetVotingPowerChangeLazyQueryHookResult = ReturnType<
  typeof useGetVotingPowerChangeLazyQuery
>;
export type GetVotingPowerChangeSuspenseQueryHookResult = ReturnType<
  typeof useGetVotingPowerChangeSuspenseQuery
>;
export type GetVotingPowerChangeQueryResult = Apollo.QueryResult<
  GetVotingPowerChangeQuery,
  GetVotingPowerChangeQueryVariables
>;
 ...
 * });
 */
export function useGetProposalNonVotersQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetProposalNonVotersQuery,
    GetProposalNonVotersQueryVariables
  > &
    (
      | { variables: GetProposalNonVotersQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetProposalNonVotersQuery,
    GetProposalNonVotersQueryVariables
  >(GetProposalNonVotersDocument, options);
}
export function useGetProposalNonVotersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetProposalNonVotersQuery,
    GetProposalNonVotersQueryVariables
  >,
...
export function useGetProposalNonVotersSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetProposalNonVotersQuery,
...
export type GetProposalNonVotersQueryHookResult = ReturnType<
  typeof useGetProposalNonVotersQuery
>;
export type GetProposalNonVotersLazyQueryHookResult = ReturnType<
  typeof useGetProposalNonVotersLazyQuery
>;
export type GetProposalNonVotersSuspenseQueryHookResult = ReturnType<
  typeof useGetProposalNonVotersSuspenseQuery
>;
export type GetProposalNonVotersQueryResult = Apollo.QueryResult<
  GetProposalNonVotersQuery,
  GetProposalNonVotersQueryVariables
>;
 ...
 * });
 */
export function useGetAccountPowerQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetAccountPowerQuery,
    GetAccountPowerQueryVariables
  > &
    (
      | { variables: GetAccountPowerQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAccountPowerQuery, GetAccountPowerQueryVariables>(
    GetAccountPowerDocument,
    options,
  );
}
export function useGetAccountPowerLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetAccountPowerQuery,
    GetAccountPowerQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    GetAccountPowerQuery,
    GetAccountPowerQueryVariables
  >(GetAccountPowerDocument, options);
}
export function useGetAccountPowerSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetAccountPowerQuery,
...
export type GetAccountPowerQueryHookResult = ReturnType<
  typeof useGetAccountPowerQuery
>;
export type GetAccountPowerLazyQueryHookResult = ReturnType<
  typeof useGetAccountPowerLazyQuery
>;
export type GetAccountPowerSuspenseQueryHookResult = ReturnType<
  typeof useGetAccountPowerSuspenseQuery
>;
export type GetAccountPowerQueryResult = Apollo.QueryResult<
  GetAccountPowerQuery,
  GetAccountPowerQueryVariables
>;
 ...
 * });
 */
export function useGetUserVoteQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetUserVoteQuery,
    GetUserVoteQueryVariables
  > &
    (
      | { variables: GetUserVoteQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetUserVoteQuery, GetUserVoteQueryVariables>(
    GetUserVoteDocument,
    options,
  );
}
export function useGetUserVoteLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetUserVoteQuery,
    GetUserVoteQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetUserVoteQuery, GetUserVoteQueryVariables>(
    GetUserVoteDocument,
    options,
  );
}
export function useGetUserVoteSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetUserVoteQuery,
  ...
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetUserVoteQuery, GetUserVoteQueryVariables>(
    GetUserVoteDocument,
    options,
  );
}
export type GetUserVoteQueryHookResult = ReturnType<typeof useGetUserVoteQuery>;
export type GetUserVoteLazyQueryHookResult = ReturnType<
  typeof useGetUserVoteLazyQuery
>;
export type GetUserVoteSuspenseQueryHookResult = ReturnType<
  typeof useGetUserVoteSuspenseQuery
>;
export type GetUserVoteQueryResult = Apollo.QueryResult<
  GetUserVoteQuery,
  GetUserVoteQueryVariables
>;
 ...
 * });
 */
export function useGetHistoricalBalancesQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetHistoricalBalancesQuery,
    GetHistoricalBalancesQueryVariables
  > &
    (
      | { variables: GetHistoricalBalancesQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetHistoricalBalancesQuery,
    GetHistoricalBalancesQueryVariables
  >(GetHistoricalBalancesDocument, options);
}
export function useGetHistoricalBalancesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetHistoricalBalancesQuery,
    GetHistoricalBalancesQueryVariables
  >,
...
export function useGetHistoricalBalancesSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetHistoricalBalancesQuery,
...
export type GetHistoricalBalancesQueryHookResult = ReturnType<
  typeof useGetHistoricalBalancesQuery
>;
export type GetHistoricalBalancesLazyQueryHookResult = ReturnType<
  typeof useGetHistoricalBalancesLazyQuery
>;
export type GetHistoricalBalancesSuspenseQueryHookResult = ReturnType<
  typeof useGetHistoricalBalancesSuspenseQuery
>;
export type GetHistoricalBalancesQueryResult = Apollo.QueryResult<
  GetHistoricalBalancesQuery,
  GetHistoricalBalancesQueryVariables
>;
export const GetProposalsActivityDocument = gql`
  query GetProposalsActivity(
    $address: String!
    $fromDate: NonNegativeInt
    $skip: NonNegativeInt
    $limit: PositiveInt
 ...
 * });
 */
export function useGetProposalsActivityQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetProposalsActivityQuery,
    GetProposalsActivityQueryVariables
  > &
    (
      | { variables: GetProposalsActivityQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetProposalsActivityQuery,
    GetProposalsActivityQueryVariables
  >(GetProposalsActivityDocument, options);
}
export function useGetProposalsActivityLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetProposalsActivityQuery,
    GetProposalsActivityQueryVariables
  >,
...
export function useGetProposalsActivitySuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetProposalsActivityQuery,
...
export type GetProposalsActivityQueryHookResult = ReturnType<
  typeof useGetProposalsActivityQuery
>;
export type GetProposalsActivityLazyQueryHookResult = ReturnType<
  typeof useGetProposalsActivityLazyQuery
>;
export type GetProposalsActivitySuspenseQueryHookResult = ReturnType<
  typeof useGetProposalsActivitySuspenseQuery
>;
export type GetProposalsActivityQueryResult = Apollo.QueryResult<
  GetProposalsActivityQuery,
  GetProposalsActivityQueryVariables
>;
 ...
 * });
 */
export function useGetDaoAddressesAccountBalancesQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDaoAddressesAccountBalancesQuery,
    GetDaoAddressesAccountBalancesQueryVariables
  > &
    (
      | {
          variables: GetDaoAddressesAccountBalancesQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    ),
  ...
  return Apollo.useQuery<
    GetDaoAddressesAccountBalancesQuery,
    GetDaoAddressesAccountBalancesQueryVariables
  >(GetDaoAddressesAccountBalancesDocument, options);
}
export function useGetDaoAddressesAccountBalancesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDaoAddressesAccountBalancesQuery,
    GetDaoAddressesAccountBalancesQueryVariables
  >,
...
export function useGetDaoAddressesAccountBalancesSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDaoAddressesAccountBalancesQuery,
...
export type GetDaoAddressesAccountBalancesQueryHookResult = ReturnType<
  typeof useGetDaoAddressesAccountBalancesQuery
>;
export type GetDaoAddressesAccountBalancesLazyQueryHookResult = ReturnType<
  typeof useGetDaoAddressesAccountBalancesLazyQuery
>;
export type GetDaoAddressesAccountBalancesSuspenseQueryHookResult = ReturnType<
  typeof useGetDaoAddressesAccountBalancesSuspenseQuery
>;
export type GetDaoAddressesAccountBalancesQueryResult = Apollo.QueryResult<
  GetDaoAddressesAccountBalancesQuery,
  GetDaoAddressesAccountBalancesQueryVariables
>;
 ...
 * });
 */
export function useGetDelegationHistoryCountQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegationHistoryCountQuery,
    GetDelegationHistoryCountQueryVariables
  > &
    (
      | { variables: GetDelegationHistoryCountQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetDelegationHistoryCountQuery,
    GetDelegationHistoryCountQueryVariables
  >(GetDelegationHistoryCountDocument, options);
}
export function useGetDelegationHistoryCountLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegationHistoryCountQuery,
    GetDelegationHistoryCountQueryVariables
  >,
...
export function useGetDelegationHistoryCountSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegationHistoryCountQuery,
...
export type GetDelegationHistoryCountQueryHookResult = ReturnType<
  typeof useGetDelegationHistoryCountQuery
>;
export type GetDelegationHistoryCountLazyQueryHookResult = ReturnType<
  typeof useGetDelegationHistoryCountLazyQuery
>;
export type GetDelegationHistoryCountSuspenseQueryHookResult = ReturnType<
  typeof useGetDelegationHistoryCountSuspenseQuery
>;
export type GetDelegationHistoryCountQueryResult = Apollo.QueryResult<
  GetDelegationHistoryCountQuery,
  GetDelegationHistoryCountQueryVariables
>;
export const GetDelegationHistoryItemsDocument = gql`
  query GetDelegationHistoryItems(
    $delegator: String!
    $after: String
    $before: String
    $orderBy: String = "timestamp"
 ...
 * });
 */
export function useGetDelegationHistoryItemsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetDelegationHistoryItemsQuery,
    GetDelegationHistoryItemsQueryVariables
  > &
    (
      | { variables: GetDelegationHistoryItemsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetDelegationHistoryItemsQuery,
    GetDelegationHistoryItemsQueryVariables
  >(GetDelegationHistoryItemsDocument, options);
}
export function useGetDelegationHistoryItemsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetDelegationHistoryItemsQuery,
    GetDelegationHistoryItemsQueryVariables
  >,
...
export function useGetDelegationHistoryItemsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetDelegationHistoryItemsQuery,
...
export type GetDelegationHistoryItemsQueryHookResult = ReturnType<
  typeof useGetDelegationHistoryItemsQuery
>;
export type GetDelegationHistoryItemsLazyQueryHookResult = ReturnType<
  typeof useGetDelegationHistoryItemsLazyQuery
>;
export type GetDelegationHistoryItemsSuspenseQueryHookResult = ReturnType<
  typeof useGetDelegationHistoryItemsSuspenseQuery
>;
export type GetDelegationHistoryItemsQueryResult = Apollo.QueryResult<
  GetDelegationHistoryItemsQuery,
  GetDelegationHistoryItemsQueryVariables
>;
 ...
 * });
 */
export function useGetTopTokenHoldersQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetTopTokenHoldersQuery,
    GetTopTokenHoldersQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetTopTokenHoldersQuery,
    GetTopTokenHoldersQueryVariables
  >(GetTopTokenHoldersDocument, options);
}
export function useGetTopTokenHoldersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTopTokenHoldersQuery,
    GetTopTokenHoldersQueryVariables
  >,
...
export function useGetTopTokenHoldersSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetTopTokenHoldersQuery,
...
export type GetTopTokenHoldersQueryHookResult = ReturnType<
  typeof useGetTopTokenHoldersQuery
>;
export type GetTopTokenHoldersLazyQueryHookResult = ReturnType<
  typeof useGetTopTokenHoldersLazyQuery
>;
export type GetTopTokenHoldersSuspenseQueryHookResult = ReturnType<
  typeof useGetTopTokenHoldersSuspenseQuery
>;
export type GetTopTokenHoldersQueryResult = Apollo.QueryResult<
  GetTopTokenHoldersQuery,
  GetTopTokenHoldersQueryVariables
>;
 ...
 * });
 */
export function useGetTokenHoldersCoutingQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetTokenHoldersCoutingQuery,
    GetTokenHoldersCoutingQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetTokenHoldersCoutingQuery,
    GetTokenHoldersCoutingQueryVariables
  >(GetTokenHoldersCoutingDocument, options);
}
export function useGetTokenHoldersCoutingLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTokenHoldersCoutingQuery,
    GetTokenHoldersCoutingQueryVariables
  >,
...
export function useGetTokenHoldersCoutingSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetTokenHoldersCoutingQuery,
...
export type GetTokenHoldersCoutingQueryHookResult = ReturnType<
  typeof useGetTokenHoldersCoutingQuery
>;
export type GetTokenHoldersCoutingLazyQueryHookResult = ReturnType<
  typeof useGetTokenHoldersCoutingLazyQuery
>;
export type GetTokenHoldersCoutingSuspenseQueryHookResult = ReturnType<
  typeof useGetTokenHoldersCoutingSuspenseQuery
>;
export type GetTokenHoldersCoutingQueryResult = Apollo.QueryResult<
  GetTokenHoldersCoutingQuery,
  GetTokenHoldersCoutingQueryVariables
>;
...
export function useTokenInfoQuery(
  baseOptions?: Apollo.QueryHookOptions<
    TokenInfoQuery,
    TokenInfoQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TokenInfoQuery, TokenInfoQueryVariables>(
    TokenInfoDocument,
    options,
  );
}
export function useTokenInfoLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TokenInfoQuery, TokenInfoQueryVariables>(
    TokenInfoDocument,
    options,
  );
}
export function useTokenInfoSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<TokenInfoQuery, TokenInfoQueryVariables>,
) {
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<TokenInfoQuery, TokenInfoQueryVariables>(
    TokenInfoDocument,
    options,
  );
}
export type TokenInfoQueryHookResult = ReturnType<typeof useTokenInfoQuery>;
export type TokenInfoLazyQueryHookResult = ReturnType<
  typeof useTokenInfoLazyQuery
>;
export type TokenInfoSuspenseQueryHookResult = ReturnType<
  typeof useTokenInfoSuspenseQuery
>;
export type TokenInfoQueryResult = Apollo.QueryResult<
  TokenInfoQuery,
  TokenInfoQueryVariables
>;
export const TransactionsDocument = gql`
  query Transactions(
    ...
    $minAmount: String
    $maxAmount: String
    $sortOrder: queryInput_transactions_sortOrder
    $affectedSupply: JSON
    $fromDate: Int
    $toDate: Int
    $includes: JSON
 ...
 * });
 */
export function useVotingPowersQuery(
  baseOptions: Apollo.QueryHookOptions<
    VotingPowersQuery,
    VotingPowersQueryVariables
  > &
    (
      | { variables: VotingPowersQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<VotingPowersQuery, VotingPowersQueryVariables>(
    VotingPowersDocument,
    options,
  );
}
export function useVotingPowersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    VotingPowersQuery,
    VotingPowersQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<VotingPowersQuery, VotingPowersQueryVariables>(
    VotingPowersDocument,
    options,
  );
}
export function useVotingPowersSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        VotingPowersQuery,
  ...
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<VotingPowersQuery, VotingPowersQueryVariables>(
    VotingPowersDocument,
    options,
  );
}
export type VotingPowersQueryHookResult = ReturnType<
  typeof useVotingPowersQuery
>;
export type VotingPowersLazyQueryHookResult = ReturnType<
  typeof useVotingPowersLazyQuery
>;
export type VotingPowersSuspenseQueryHookResult = ReturnType<
  typeof useVotingPowersSuspenseQuery
>;
export type VotingPowersQueryResult = Apollo.QueryResult<
  VotingPowersQuery,
  VotingPowersQueryVariables
>;
