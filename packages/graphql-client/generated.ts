...
export type DaoFilter = {
  ...
  proposalThreshold_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  proposalThreshold_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  timelockDelay_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
  ...
  votingPeriod_not_in?: InputMaybe<
    Array<InputMaybe<Scalars["BigInt"]["input"]>>
  >;
};
...
export type Query_Transactions_Transactions_Items = {
  ...
  delegations: Array<
    Maybe<Query_Transactions_Transactions_Items_Delegations_Items>
  >;
  ...
  transactionHash: Scalars["String"]["output"];
  transfers: Array<
    Maybe<Query_Transactions_Transactions_Items_Transfers_Items>
  >;
};
  ...
  delegations: {
    ...
    items: Array<{
      ...
      delegate?: {
        ...
        powers?: {
          __typename?: "accountPowerPage";
          items: Array<{ __typename?: "accountPower"; votingPower: any }>;
        } | null;
      } | null;
    }>;
    pageInfo: {
...
export function useGetDaoDataQuery(
  ...
  > &
    (
      | { variables: GetDaoDataQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
