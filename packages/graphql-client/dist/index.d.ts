...
export declare const GetDaoDataDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useGetDaoDataQuery(baseOptions: Apollo.QueryHookOptions<GetDaoDataQuery, GetDaoDataQueryVariables> & ({
    variables: GetDaoDataQueryVariables;
    skip?: boolean;
} | {
    skip: boolean;
})): Apollo.QueryResult<GetDaoDataQuery, Exact<{
    daoId: Scalars["String"]["input"];
}>>;
export declare function useGetDaoDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDaoDataQuery, GetDaoDataQueryVariables>): Apollo.LazyQueryResultTuple<GetDaoDataQuery, Exact<{
    daoId: Scalars["String"]["input"];
}>>;
export declare function useGetDaoDataSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetDaoDataQuery, GetDaoDataQueryVariables>): Apollo.UseSuspenseQueryResult<GetDaoDataQuery | undefined, Exact<{
    daoId: Scalars["String"]["input"];
}>>;
